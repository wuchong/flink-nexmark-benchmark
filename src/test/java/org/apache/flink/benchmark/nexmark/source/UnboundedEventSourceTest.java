...
import org.apache.flink.benchmark.nexmark.sources.generator.GeneratorCheckpoint;
...
public class UnboundedEventSourceTest {
  ...
  private static class EventIdChecker {
    ...
    public void add(int n, UnboundedSource.UnboundedReader<Event> reader, Generator modelGenerator)
        throws IOException {
      for (int i = 0; i < n; i++) {
  ...
  public void resumeFromCheckpoint() throws IOException {
    ...
    UnboundedSource.UnboundedReader<Event> reader = source.createReader(options, null);
